...
if (salarioBruto>0 && salarioBruto<=1556.94){
    ...
    console.log("Esse valor não pode ser seu salário")
}
salBase = salarioBruto - inss;
if (salBase>0 && salBase<=1903.98){
    iRenda = salBase * 0;
} else if (salBase>1903.98 && salBase<=2826.65){ 
    iRenda = salBase * 0.075 - 142.80;
} else if (salBase>2826.65 && salBase<=3751.05){ 
    iRenda = salBase * 0.15 - 354.80;
} else if (salBase>3751.05 && salBase<=4664.68){ 
    iRenda = salBase * 0.225 - 636.13;
} else if (salBase>4664.68){ 
    iRenda = salBase * 0.275 - 869.36;
} else {
    console.log("Entre com um valor maior que zaro");
}

salLiquido = salBase - iRenda;
